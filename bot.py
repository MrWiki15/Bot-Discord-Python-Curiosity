...
curiosities = [
  ...
  'Dato curioso el yoyo primero se uso como arma en Asia para luego volverse el juego mas popular del planeta. Eso no te recuerda a algo?...... !En efecto! La tecnologia NFT y Blockchain en sus comienzos fue utilizada para actos de maldad, pero poco a poco se convertira en la tecnologia que domine del manana!             Posdata:(No tengo n[con palito] pero ustedes entendieron)',
  'Sabias que cada rey de las cartas representa a un gran rey de la historia: 1)Espadas: El rey David. 2)Tréboles: Alejandro Magno. 3)Corazones: Carlomagno. 4)Diamantes: Julio César.',
  'Sabias que un gramo de oro se puede expandir hasta 20km',
  '',
  '',
  '',
  '',
